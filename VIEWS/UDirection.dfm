object frm_Direction: Tfrm_Direction
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'frm_Direction'
  ClientHeight = 253
  ClientWidth = 547
  Color = clWhite
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object dbgrid_Direction: TDBGrid
    Left = 0
    Top = 46
    Width = 547
    Height = 156
    ...
    TitleFont.Style = []
    OnDrawColumnCell = dbgrid_DirectionDrawColumnCell
    Columns = <
      item
        Alignment = taCenter
        Expanded = False
  ...
  object Relative_Bottom: TRelativePanel
    ...
    object btn_add: TBitBtn
      ...
      Height = 40
      Cursor = crHandPoint
      Action = DM_API.Act_Direction_Add
      Anchors = []
      BiDiMode = bdRightToLeft
