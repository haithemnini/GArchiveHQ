object frm_Archivage: Tfrm_Archivage
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'frm_Archivage'
  ClientHeight = 253
  ClientWidth = 602
  Color = clWhite
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object dbgrid_Archivage: TDBGrid
    Left = 0
    Top = 46
    Width = 602
    Height = 156
    ...
    TitleFont.Style = []
    OnDrawColumnCell = dbgrid_ArchivageDrawColumnCell
    Columns = <
      item
        Alignment = taCenter
        Expanded = False
      ...
      item
        ...
        Font.Style = []
        Title.Alignment = taCenter
        Title.Caption = #1575#1604#1589#1601
        Title.Font.Charset = DEFAULT_CHARSET
        Title.Font.Color = clWindowText
        Title.Font.Height = -13
        Title.Font.Name = 'Arabic UI Display Medium'
      ...
      item
        ...
        Font.Style = []
        Title.Alignment = taCenter
        Title.Caption = #1575#1587#1605' '#1575#1604#1585#1601
        Title.Font.Charset = DEFAULT_CHARSET
        Title.Font.Color = clWindowText
        Title.Font.Height = -13
        Title.Font.Name = 'Arabic UI Display Medium'
  ...
  object PNL_TOP: TPanel
    ...
    object gro_Seah: TGroupBox
      ...
      ParentFont = False
      TabOrder = 1
      object Rb_Classer: TRadioButton
        Left = 12
        Top = 7
        Width = 69
        Height = 25
  ...
  object Relative_Bottom: TRelativePanel
    ...
    object btn_add: TBitBtn
      ...
      Height = 40
      Cursor = crHandPoint
      Action = DM_API.Act_Archivage_Add
      Anchors = []
      BiDiMode = bdRightToLeft
